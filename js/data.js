...
const PROFILE = {
  ...
  education: [
    { ko: "서울과학기술대학교 일반대학원, 조형예술과 수료, 서울", en: "Coursework Completed in Fine Arts, Graduate School of Seoul National University of Science and Technology, Seoul" },
    { ko: "서울과학기술대학교 조형대학, 조형예술학과 졸업, 서울", en: "Bachelor of Fine Arts in Fine Arts from Seoul National University of Science and Technology, Seoul" }
  ]
};
...
const POSTS = {
  "zg1": {
   ...
   "zg3": {
    ...
    excerpt: { ko: "전시 서문", en: "Preface" },
    body: {
      ko: "일전에 시네마와는 다른 결의 러닝타임이 회화에서도 흐른다는 얘기를 이예진 작가에게 들은 적이 있었다. 비록 그 화면은 영상처럼 움직이지 않더라도 들여다보지 않고는 찰나로만 목격 할 수 없는 시간의 층위가 있다는 얘기가 흥미롭게 다가왔다. 보는 이에게는 순간적인 장면 일지라도 실제로 그 순간은 작가가 순간순간의 조형적 사유와 신중하면서도 과감한 획들로 층층이 쌓았을 표면일 테니 말이다. 그리고 이는 작가들마다 놓인 처지와 경험 그리고 재료와 씨름하는 순간의 판단들에 따라 각기 다른 시간에 개별적으로 구현되어졌을 것이다. 이처럼 양식의 차이를 도래하는 창작의 과정은 회화가 단지 매체의 고유성만으로 규정하기도, 작가의 미학관 만으로 특징짓기 어렵다는 것을 상기시켜준다. 왜냐하면 회화는 작가가 현존하는 순간들과 회화의 체계가 부딪히며 맞물릴 때, 독립적인 공간이자 존재로서 나타나기 때문이다 이번 더 소소에서 진행되는 ‘나의 회화적 순간’展은 회화가 발생하고 완성되는 순간에 대한 자문으로부터 비롯되었다. 이와 같은 논의가 제기되었던 것은 해당 전시의 참여작가들이 고정된 결과값 보다는 창작과정으로부터 회화의 형식을 발견하고 형성해 나가는 유사성이 있던 까닭이었다. 각자의 전략들에따라 레퍼런스의 수집 및 작품 구상이 선행되었고, 그리는 방식들이 선택되었을 지라도, 그림은 예측에서 조금 빗기거나 벗어나 다른 모습으로 마무리되는 경우가 허다했 다. 이들은 매순간의 그리기를 통해 회화의 흔적을 쫓으며 화면 위를 유영하다 마주친 우연들을 나름 체계화함으로써 회화를 도출하는 순간을 맞이하였다.\n\n\n 권회찬 작가와 박정윤 작가 그리고 이예진 작가는 이성적인 접근으로 그림을 출발하기 보다는 즉흥적으로 내던진 몸짓에서부터 단계적인 그리기를 수행하는 편이다. 한 예로 자화상의 제목을 가진 권회찬 작가의 회화는 명암이 있는 환영적 공간에 사실적 인물이 아닌 출처가 불분명한 곡면의 조형물을 등장 시키는데 해당 조형물은 사실 작가가 자신의 낙서 위로 면들을 덧입혀 그린 허구적 모형이다 작가는 무의미해 보이는 낙서에서도 사람마다의 무의식이 투영되고 고유한 제스처가 나타난다고 생각한다 여기에 그는 본인 회화의 영점으로 설정한 명암법과 원근법을 응용함으로써 실재같은 허상을 그리는데 이와 같이 무의식에서 의식으로 넘어가는 그리기 방식을 통해 작가는 자신과 회화의 내부로부터 본인의 회화적 본질을 모색하고자 한다.\n\n권회찬 작가의 그리기는 화면의 중앙에서부터 비롯된다면 반대로 박정윤 작가는 화면의 경계에서부터 내부로 향하는 그리기를 보여준다 작가는 평면적 오브제를 점유해야 할 재료가 아닌 대등한 존재로써 바라보는 경향이 있다. 규격화된 육면체의 면적이 몸짓의 제약처럼 다가왔다는 박정윤 작가는 그것을 부정하는 대신 존중하고 포용하는 방식으로 화면의 제한을 극복하는 추상화를 선보인다. 제한된 화면 속에서 공간을 심층화하고자 작가는 선회하는 유기적 형상을 겹겹이 쌓아 시선의 흐름을 내부로 몰입시키며 외부적으로는 안료의 물성과 돌출된 평면을 드러내어 회화의 입체성을 부각시킨다 이 때문에 그녀의 회화에선 환영적 공간과 실재의 공간 사이를 넘나드는 공간의 확장성이 나타나게 된다.\n\n앞선 두 작가는 회화의 내부에 집중하거나 내부와 외부의 관계를 조율하는 몸짓이었다면 이예진 작가는 내부로부터 외부로 뻗쳐가는 몸짓을 구사한다. 작가는 본인의 회화를 비선형적인 내러티브로 설명하기도 하는데 이는 타자와의 관계로부터 발생한 감정을 서사로 기록 하며 해당 이야기를 기반으로 본인의 감정을 회화적 제스처(gesture)로 재해석하기 때문이다. 이와 같이 감정을 가시화하는 몸짓에서부터 점층적으로 그려나가다보니, 그의 그림에선 신체성이 두드러질 수밖에 없다. 그 속에 나타난 몸짓의 흔적들은 불협화음처럼 서로 뒤엉키다가 화합 을 이루며, 어느 순간에는 독자적인 시공간을 형성하기에 이른다. 이중에는 손, 눈과 같은 신체적 형상이 드러나는데, 이와 같은 단서는 감정이 증폭된 작가의 회화를 한층 더 지시성이 있는 서사적 회화로 돋보여준다.\n\n이들과는 반대로 본능적인 행위보다 계산적으로 작업을 진행하는 이도 있다. 아날로그보다 디지털 화면으로 세계를 마주하는 것이 익숙한 김상소 작가에게 디지털 이미지는 가상이 아닌 실재의 일부이다 실제로 그의 회화 속에서 등장하는 모든 조형적 요소들은 디지털 이미지에서 추출된 정보들로, 그는 아카이빙 한 이미지 데이터들을 가지고 순차적으로 그리는 프로세스를 설정한다. 출발은 객관적인 데이터와 구체적인 계획으로부터 출발을 하였지만 아이러니하게도 완성지점에 다다르면 여러 회화적 변수들로 인해 정보는 사라지고 회화만 이 남게 된다. 다양한 장르의 이미지들을 절충하고 해체하며 누적하는 과정을 통해 작가는 과잉된 이미지들을 회화 안에 수용하고 체계화할 수 있는 범위를 실험 해 나간다.\n\n어떤 작가들은 데이터 자료 이외에 삶의 밀접한 곳으로부터 회화의 소재를 발견하여 모으기도 한다 자기 앞에 놓인 순간순간의 상황과 사건들 그리고 이미지들에 대해 드로잉으로 반응 하 는 조완준 작가는 이를 다시 회화 안에서 새로운 관계로 재조합 하는 것을 즐긴다. 작가에게 채택된 소재들은 그것의 고유한 정보보다는 조형적 요소로써 의미를 두며 정체성이 생략된 대상들의 조합을 통해 순간적인 상황과 임의적인 표면성을 드러낸다. 이러한 회화 속 대상을 미숙한 존재로 빗대는 작가는 그림을 어눌하게 표현하는 것을 고수하는 편인데 이를 나타내고자 그는 붓터치를 의도적으로 뭉개거나 거칠게 표현하며 대상의 특징과 형태를 단순화함으로써 회화적인 실체로 부각을 시킨다. 신재민 작가도 조완준 작가처럼 주변으로부터 수집하지만, 다른 점이 있다면 본인이 감각적으로 경험하고 교감한 존재들과 장소들을 이미지나 기호적으로 차용한다는 점이다. 산책과 여행 중에 기록한 스냅샷 혹은 드로잉과 일기장 등 작가는 그 속에 등장하는 대상들을 모아 관객이 자유롭게 모험할 수 있는 몽환적인 장소를 그려낸다. 유저의 선택에 따라 내러티브가 달라지는 게임의 오픈월드처럼 작가가 그려낸 가상 세계와 가상 인물들은 고정된 서사를 가리키고 있지 않는다. 관객 각자의 시선이 향하는 방향과 순서에 따라 그림 속의 이야기는 유추가 되고 관념 속에 상상이 되어 진다. 이러한 것이 가능 할 수 있는 것은 그의 그림 속 존재들은 서로에게 위계적이지 않기 때문이다. 무의미한 배경이자 주변부였을 대상들은 회화 속에 떠다니는 아바타로 변모하여 서사를 유발시키는 기폭제로 역할을 수행해 나간다.\n\n마지막으로 정주원 작가는 사회적으로 존재적으로 마주한 허무와 냉소의 순간을 회화적 상황으로 기록한다. 그의 회화 속에 등장하는 장면들은 어딘가 불안정하고 위태롭게 일렁이는 형상을 띠고 있는데 이는 그가 백붓을 사용하지 않고 세필로만 점진적으로 그려 나가는 방식에서 비롯된 양상이다. 비록 얇은 붓 터치일지라도 좁고 세밀했던 면들은 환영 속에서는 덩어리로 뭉쳐지고, 표면으로는 두터운 마티에르(matiere)를 이루어 시각적 균형과 물리적인 안정감을 구축한다. 이와 같은 창작의 과정은 작가에게 있어 심리적 불안을 소거하는 일임과 동시에 사회의 비극을 서사적인 상상화로 해석하는 사실 기반의 작업이기도 하다.\n\n\n작가들마다 그리는 유형과 감각하는 순간들이 다르니 그들이 스스로 발견한 회화의 양식들과 이론들은 독자성이 현저할 수밖에 없다. 이처럼 일곱 작가들의 창작과정을 기반으로 이번 전시에서는 회화의 특수성보다는 회화를 특수하게 만드는 현존의 순간들을 역추적 해보는 취지에서 기획을 하게 되었다. 따라서 전시는 회화는 무엇인가가 아닌, 무엇이 회화를 가능하게 만드는가에 대한 질문을 되묻는 자리다. 더불어 7인의 다른 회화들이 충돌하면서도 조화를 이루는 역설의 공간에서 뜻밖의 방문객들이 각자의 호흡 발걸음 그리고 시선의 흐름에 따라 자신들만의 회화적 순간을 향유할 것이라 기대해본다.\n\n\n[right]글 양기찬",
      en: ""
    }
  }, 
  ...
  "zs3-1": {
    title: { ko: "해설하는 예술가의 딜레마(Dilemma)", en: "The Dilemma of the Self-Explaining Artist" },
